...
import { CreatePrescriptionRequest } from '../../../core/models/prescription.model';
import { AppointmentsService } from '../../../core/services/appointments.service';
import { AuthService } from '../../../core/services/auth.service';
import { PrescriptionService } from '../../../core/services/prescription.service';

interface DoctorAppointmentOption extends Appointment {
  patient?: {
    id: string;
    name: string;
  };
    ...
    <div class="prescription-container">
      <mat-card class="prescription-card">
        <mat-card-header>
          ...
          <mat-card-subtitle
            >Fill in the prescription details</mat-card-subtitle
          >
        </mat-card-header>
          ...
          >
              ...
              <div class="form-grid">
                <mat-form-field appearance="outline" class="full-width">
                  ...
                  <mat-select
                    ...
                    (selectionChange)="onAppointmentSelected($event.value)"
                    required
                  >
                    <mat-option
                      *ngFor="let appointment of doctorAppointments"
                  ...
                  <mat-hint *ngIf="isLoadingAppointments"
                    >Loading your assigned appointments...</mat-hint
                  >
                  <mat-hint
                    *ngIf="
                      !isLoadingAppointments && doctorAppointments.length === 0
                    "
                  >
                ...
                <mat-form-field appearance="outline">
                  ...
                  <mat-error
                    *ngIf="
                      prescriptionForm.get('patientId')?.hasError('required')
                    "
                  >
                ...
                <mat-form-field appearance="outline">
                  ...
                  <input matInput formControlName="appointmentId" readonly />
                  <mat-icon matSuffix>event</mat-icon>
                </mat-form-field>

                <mat-form-field appearance="outline">
                  <mat-label>Doctor ID</mat-label>
                  <input matInput formControlName="doctorId" readonly />
                ...
                <mat-form-field appearance="outline" class="full-width">
                  ...
                  <mat-error
                    *ngIf="
                      prescriptionForm.get('diagnosis')?.hasError('required')
                    "
                  >
                  ...
                  <div class="form-grid">
                    ...
                    <mat-form-field appearance="outline">
                      ...
                      <mat-select formControlName="frequency" required>
                        ...
                        <mat-option value="Three times daily"
                          >Three times daily</mat-option
                        >
                        <mat-option value="Four times daily"
                          >Four times daily</mat-option
                        >
                        <mat-option value="Every 4 hours"
                          >Every 4 hours</mat-option
                        >
                        <mat-option value="Every 6 hours"
                          >Every 6 hours</mat-option
                        >
                        <mat-option value="Every 8 hours"
                          >Every 8 hours</mat-option
                        >
                        <mat-option value="As needed">As needed</mat-option>
                        <mat-option value="Before meals"
                          >Before meals</mat-option
                        >
            ...
            <div class="section">
              ...
              <mat-form-field appearance="outline" class="full-width">
                ...
                <mat-error
                  *ngIf="
                    prescriptionForm.get('instructions')?.hasError('required')
                  "
                >
            ...
            <div class="form-actions">
              ...
              <button
                ...
                color="primary"
                type="submit"
                [disabled]="isSubmitting || prescriptionForm.invalid"
              >
...
export class PrescriptionCreateComponent implements OnInit, OnDestroy {
  ...
  isSubmitting = false;
  doctorAppointments: DoctorAppointmentOption[] = [];
  ...
  private initializeForm(): void {
    this.prescriptionForm = this.fb.group({
      selectedAppointmentId: [this.appointmentId || '', Validators.required],
  ...
  private initializeDoctorContext(): void {
    ...
    this.doctorId = currentUser?.doctorProfile?.id || currentUser?.id || '';
    this.prescriptionForm.patchValue({ doctorId: this.doctorId });
  }
      ...
      .subscribe({
        next: (appointments) => {
          this.doctorAppointments = (appointments ||
            []) as DoctorAppointmentOption[];
          this.isLoadingAppointments = false;

          if (this.appointmentId) {
            this.onAppointmentSelected(this.appointmentId);
          }
        },
        error: (error) => {
          console.error('Error loading doctor appointments:', error);
          this.snackBar.open('Failed to load assigned appointments', 'Close', {
            duration: 3000,
          });
          this.isLoadingAppointments = false;
        },
  ...
  onAppointmentSelected(appointmentId: string): void {
    const selectedAppointment = this.doctorAppointments.find(
    ...
    this.prescriptionForm.patchValue({
      ...
      patientId:
        selectedAppointment.patient?.id || selectedAppointment.patientId,
      patientName: selectedAppointment.patient?.name || '',
      doctorId: this.doctorId,
    });
  }

  formatAppointmentDate(dateValue: Date | string): string {
    if (!dateValue) {
      return 'Unknown date';
    }
