              ...
              <div class="calendar-days">
                ...
                >
                  ...
                  <div
                    ...
                    *ngIf="day.appointments.length > 0"
                  >
                    <div
            ...
            <div class="list-filters">
              <mat-form-field appearance="outline">
                ...
                <mat-select
                  ...
                  (selectionChange)="filterAppointments()"
                >
            ...
            <div class="appointments-list">
              ...
              >
                ...
                <p>
                  {{
                    selectedStatus
                      ? 'No appointments with selected status'
...
export class AppointmentCalendarComponent implements OnInit, OnDestroy {
  ...
  editAppointment(appointment: Appointment): void {
    this.snackBar.open(`Editing appointment ${appointment.id}`, 'Close', {
      duration: 2000,
    });
  ...
  getAppointmentsForTimeSlot(date: Date, time: string): Appointment[] {
    return this.appointments.filter((apt) => {
      const aptDate = new Date(apt.date);
      return (
        aptDate.toDateString() === date.toDateString() && apt.startTime === time
      );
    });
  }
